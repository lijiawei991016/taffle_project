			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-lg-6 col-md-8 text-center">
						<h2 class="h3 mb-40">重置密码</h2>
						<br />
						<div class="alert alert-danger"
							style="width: 450px; margin: auto;">${error }</div>
						<br />
						<form class="contact-form" method="post"
							action="${pageContext.request.contextPath}/client_forget_pswd">
							<div class="form-row">
								<div>
								...
								<div>
									...
									<input type="password" name="yzm" id="yzm"
										class="form-control mb-10" size="120px"
										placeholder="请输入验证码..." required="required"> <img
										id="codeImg" src="${pageContext.request.contextPath}/code_img" />
									<a href="javascript:changeImg();" rel="external nofollow">看不清</a>
								</div>
								<p style="color: gray; font-size: 17px; margin: auto;">
									<b> ————————请确认密码用户信息无误后重置密码————————</b>
								</p>
								<br /> <br /> <br /> <br />
								<div class="form-submit mt-3" style="margin: auto;">
									<input type="submit" class="btn btn-primary btn-lg btn-block"
										value="重置密码" /> <a
										href="${pageContext.request.contextPath}/login"><br /> <span
										class="btn btn-primary btn-lg btn-block">返回登录</span> </a>
								</div>
							</div>
						</form>
					</div>
