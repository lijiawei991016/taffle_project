                    ...
                    <main id="main" class="main-content col-lg-8">
                        <div class="post-content">
                            ...
                            <section class="mb-5" id="slider">
                                ...
                                <div class="slider js-slider" data-slick='{"slidesToShow": 1, "slidesToScroll": 1}'>
                                ...
                                <div class="accordion mb-5" id="accordionExamplePrimary">
                                    <div class="card">
                                        <div class="card-header" id="headingOnePrimary">
                                            <button class="btn btn-primary btn-lg " type="button" data-toggle="collapse" data-target="#collapseOnePrimary" aria-expanded="true" aria-controls="collapseOnePrimary">
                                                Accordion item #1
                                            </button>
                                        </div>

                                        <div id="collapseOnePrimary" class="collapse show" aria-labelledby="headingOnePrimary" data-parent="#accordionExamplePrimary">
                                            <div class="card-body">
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="headingTwoPrimary">
                                            <button class="btn btn-primary btn-lg collapsed" type="button" data-toggle="collapse" data-target="#collapseTwoPrimary" aria-expanded="false" aria-controls="collapseTwoPrimary">
                                                Accordion item #2
                                            </button>
                                        </div>
                                        <div id="collapseTwoPrimary" class="collapse" aria-labelledby="headingTwoPrimary" data-parent="#accordionExamplePrimary">
                                            <div class="card-body">
                                                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry’s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
                                            </div>
                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="headingThreePrimary">
                                            <button class="btn btn-primary btn-lg collapsed" type="button" data-toggle="collapse" data-target="#collapseThreePrimary" aria-expanded="false" aria-controls="collapseThreePrimary">
                                                Accordion item #3
                                            </button>
                                        </div>
                                        <div id="collapseThreePrimary" class="collapse" aria-labelledby="headingThreePrimary" data-parent="#accordionExamplePrimary">
                                            <div class="card-body">
                                                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry’s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
                                            </div>
                                        </div>
                                    </div>
                                </div> <!-- #headingOnePrimary -->
                            ...
                            <section class="mb-5" id="progress">
                                ...
                                <div class="progress progress-sm">
                                    <div class="progress-bar bg-secondary" role="progressbar" style="width: 58%" aria-valuenow="58" aria-valuemin="0" aria-valuemax="58"></div>
                                </div>
                                <div class="progress progress-sm mb-4">
                                    <div class="progress-bar bg-primary" role="progressbar" style="width: 35%" aria-valuenow="35" aria-valuemin="0" aria-valuemax="35"></div>
                                </div>

                                <div class="progress">
                                    <div class="progress-bar bg-secondary" role="progressbar" style="width: 67%" aria-valuenow="67" aria-valuemin="0" aria-valuemax="67">67%</div>
                                </div>
                                <div class="progress">
                                    <div class="progress-bar bg-primary" role="progressbar" style="width: 32%" aria-valuenow="32" aria-valuemin="0" aria-valuemax="32">32%</div>
                                </div>
                            </section>
                            ...
                            <section class="mb-5" id="buttons">
                                ...
                                <div class="d-block d-md-inline-block">
                                    ...
                                    <button type="button" class="btn btn-primary btn-lg active mr-3 mb-3">Hover</button>
                                </div>
                                <div class="d-block d-md-inline-block">
                                    <button type="button" class="btn btn-outline-primary btn-lg mr-1 mb-3">Stroke</button>
                                    <button type="button" class="btn btn-outline-primary btn-lg active mb-3">Hover</button>
                                </div>
                                <div class="d-block d-md-inline-block">
                                ...
                                <div class="d-block d-md-inline-block">
                                    ...
                                    <button type="button" class="btn btn-outline-primary active mb-3">Medium</button>
                                </div>
                                <div class="d-block d-md-inline-block">
                                    <button type="button" class="btn btn-primary btn-sm mr-1 mb-3">Small</button>
                                    <button type="button" class="btn btn-primary btn-sm active mr-3 mb-3">Small</button>
                                </div>
                                <div class="d-block d-md-inline-block">
                                    <button type="button" class="btn btn-outline-primary btn-sm mr-1 mb-3">Small</button>
                                    <button type="button" class="btn btn-outline-primary btn-sm active mb-3">Small</button>
                                </div>
                            </section>
                            ...
                            <section class="mb-2" id="featured">
                                    ...
                                    <div class="col-md-5">
                                        <div class="offer-box">
                                            ...
                                            <div class="offer-box__body">
                                                ...
                                                <a href="single-product.html" class="btn btn-outline-primary">buy $29.99</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="icon-box icon-box-left icon-box-circle mb-40">
                                            <div class="icon-box__icon"><i class="flaticon flaticon-star-shape-favorite"></i></div>
                            ...
                            <section class="mb-5" id="forms">
                                ...
                                <div class="shortcodes-col-sm">
                                    <div class="form-group mb-20">
                                        <input type="text" class="form-control mb-10" placeholder="Default">
                                        <input type="text" class="form-control mb-10 hover" placeholder="Default hover">
                                        <input type="text" class="form-control mb-10 active" placeholder="Default active">
                                    </div>

                                    <div class="form-group mb-20">
                                        <div class="form-group mb-10">
                                            <select class="form-control js-select2" data-placeholder="List default">
                                        ...
                                        <div class="form-group mb-10">
                                            <select class="form-control js-select2 hover" data-placeholder="List default">
                                        ...
                                        <div class="form-group mb-10">
                                            <select class="form-control js-select2 active" data-placeholder="List default">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-10">
                                            <input type="text" class="form-control" placeholder="Icon default">
                                            <span class="input-group-addon"><i class="mdi mdi-lock"></i></span>
                                        </div>
                                        <div class="input-group mb-10">
                                            <input type="text" class="form-control hover" placeholder="Icon hover">
                                            <span class="input-group-addon"><i class="mdi mdi-lock"></i></span>
                                        </div>
                                        <div class="input-group mb-10">
                                            <input type="text" class="form-control active" placeholder="Icon active">
                                            <span class="input-group-addon"><i class="mdi mdi-lock"></i></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <section class="mb-5" id="tabs">
                                ...
                                <div class="shortcodes-col-sm">
                                    <ul class="nav nav-tabs nav-justified nav-tabs-responsive mb-30">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link hover" href="#0">Hover</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link disabled" href="#0">Non-active</a>
                                        </li>
                                    </ul>

                                    <ul class="nav nav-tabs nav-justified nav-tabs-responsive style-2 mb-30">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#0">Active</a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <ul class="nav nav-tabs nav-justified nav-tabs-responsive style-3">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#0">Active</a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            <section class="mb-5 pb-md-5" id="typography">
                                <div class="shortcodes-col-sm">
                                    ...
                                    <div class="typography">
                                        ...
                                        <h3>Heading h3</h3>
                                        <h4>Heading h4</h4>
                                        <p>Body text. Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry’s standard dummy text ever since the 1500s, when an unknown printer.</p>
                                    </div>
                                </div>
                            </section>
