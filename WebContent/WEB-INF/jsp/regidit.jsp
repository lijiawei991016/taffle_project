...
<body  >
   <div class="content">
		<form:form action="${pageContext.request.contextPath}/login" method="post" cssClass="form" modelAttribute="user">
        ...
        <div class="sub-cont">
            <div class="img">
                ...
                <div class="img__btn" id="dd">
                    <span class="m--up"  id="clickMe" onclick="alert('${err}');">注 册</span>
