							...
							<form class="contact-form" method="post" action="">
								<div class="form-row">
									<div class="form-group col-md-6">
										<input type="text" name="contactName" id="contactName" class="form-control" placeholder="person to contact">
									</div>
									<div class="form-group col-md-6">
										<input type="text" name="contactEmail" id="contactEmail" class="form-control" placeholder="E-mail address">
									</div>
								</div>

								<div class="form-group">
									<textarea rows="5" name="contactMessage" id="contactMessage" class="form-control" placeholder="Your message"></textarea>
								</div>

								<div class="form-submit mt-3">
									<input type="submit" class="btn btn-primary btn-lg btn-block" value="提	交" />
								</div>
							</form>
						</div>
					</div>
...
<%@ include file="ClientCommon/ClientCommon_footer.jsp" %>
	...
	<div id="js-back-to-top" class="back-to-top"><i class="flaticon-up-arrow-sign"></i>回到顶部</div>
...
$(function(){
	...
	$("form").submit(function(){
		$.ajax("${pageContext.request.contextPath}/client/client_view_contact",{
			type:"POST",
			// 提交表单所有数据
			data:$("form").serialize(),
