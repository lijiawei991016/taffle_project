...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="${pageContext.request.contextPath}/server/addgoods2" enctype="multipart/form-data">  
      ...
      <div class="form-group">
        ...
        <div class="field">
          <textarea class="input" name="goodsMessage" style=" height:90px;" data-validate="required:请输入商品描述" ></textarea>
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <input type="number" step="0.01" class="input w50" value="" name="goodsPrice" data-validate="required:请输入商品单价" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <button class="button bg-main icon-check-square-o" type="submit"> 添加商品</button>
        </div>
      </div>
    </form>
  </div>
