...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="${pageContext.request.contextPath}/server/updateGoods" enctype="multipart/form-data">  
      <div class="form-group">
        <div class="label">
          <label>商品名称：</label>
        </div>
        <div class="field">
          <input type="text" class="input w50" value="${goods.goodsName }" name="goodsName" data-validate="required:请输入商品名称" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <p><input type="file" name="andgoodsPhoto" style="position:relative;"></p>
        </div>
      </div>     
      ...
      <div class="form-group">
        ...
        <div class="field">
          <textarea class="input" id="textarea1" name="goodsMessage"  style=" height:90px;" data-validate="required:请输入商品描述" ></textarea>
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <input type="number" step="0.01" class="input w50" value="${goods.goodsPrice }" name="goodsPrice" data-validate="required:请输入商品单价" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <button class="button bg-main icon-check-square-o" type="submit"> 修改商品</button>
        </div>
      </div>
    </form>
  </div>
