...
<div class="panel admin-panel">
  ...
  <table class="table table-hover text-center">
    ...
    <c:forEach items="${listblogsss }" var="listblogs">
						<tbody>
							<tr class="gradeC even">
								<td class=""><fmt:formatDate
										value="${listblogs.blogCreateDate }" pattern="yyyy-MM-dd" /></td>
								<td class=" sorting_1"><img
									src="${pageContext.request.contextPath}/statics/file/${listblogs.blogPhoto }"
									alt=""></td>
								<td>${listblogs.blogTitle }</td>
								<td>${listblogs.blogMessage }</td>
