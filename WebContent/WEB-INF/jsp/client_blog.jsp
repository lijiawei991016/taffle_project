					...
					<main id="main" class="main-content col-lg-8">
						...
						<c:forEach items="${listblogs }" var="listblog">
							<article class="post-item">
								<a href="${pageContext.request.contextPath}/client/client_single_post/${listblog.blogId }" class="post-thumb">
									<img src="${pageContext.request.contextPath}/statics/file/${listblog.blogPhoto }" alt="">
								</a>
								<div class="post-item__content">
									<h3 class="post-title">
										<a href="single-post.html">${listblog.blogTitle }</a>
									</h3>
									<div class="post-date">
									<fmt:formatDate value="${listblog.blogCreateDate }" pattern="yyyy-MM-dd"/>
									</div>
									<a href="${pageContext.request.contextPath}/client/client_single_post/${listblog.blogId }" class="read-more btn btn-outline-primary btn-lg">Read more</a>
								</div>
							</article>
							</c:forEach>
							</div>
